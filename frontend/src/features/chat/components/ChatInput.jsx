...
const ChatInput = ({ message, setMessage, handleSend, handleKeyDown, loading }) => {
    return (
        <div className="shrink-0 px-4 pb-4 pt-3 sm:px-6 sm:pb-5 lg:px-8 lg:pb-7 lg:pt-4 bg-black/40 border-t border-gray-800/60">
            <form onSubmit={handleSend} className="max-w-4xl mx-auto">
                <div className="relative min-h-[64px] rounded-2xl border border-gray-700 bg-gray-900 shadow-lg focus-within:border-indigo-500 focus-within:ring-1 focus-within:ring-indigo-500/30 transition-all duration-200">
                    <textarea
                        value={message}
